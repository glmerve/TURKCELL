...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`fixed left-0 top-0 h-screen bg-rc-bg-sidebar border-r border-rc-border flex flex-col z-50 transition-all duration-300 ${
    ...
    >
      ...
      <div className="px-3 py-3">
        <button className={`rc-btn-primary w-full flex items-center justify-center gap-2 ${collapsed ? "!px-2" : ""}`}>
          <Plus size={16} />
